...
const ProjectSection = () => {
  ...
  return (
    <>
      <section name="projects" className="pb-24 w-full px-5">
        ...
        <Carousel responsive={responsive} className="py-4 px-1">
          {Projects.map((project) => (
            <div
              key={project.id}
              className="mr-2 rounded-2xl backdrop-blur-xl bg-white/10 p-3 shadow shadow-slate-200">
              <img
                src={project.image}
                alt={project.title}
              ...
              <h5 className="mt-1 mb-2 text-sm text-gray-400">
