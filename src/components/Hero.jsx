...
const Hero = () => {
  return (
    <AuroraBackground>
      <section
        name="home"
        className="w-full h-screen bg-grid-small-white/[0.2] grid place-items-center px-5">
        <div className="flex flex-col-reverse items-center justify-center gap-5 md:gap-4 md:flex-row md:justify-between overflow-x-hidden max-w-7xl mx-auto">
          <motion.div
